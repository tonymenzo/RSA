...
The program takes in the following arguments:
    ...
    --write_path_mT2_accept_reject: Write path for the accept-reject data
...
python tuning_data_finalTwo_converter.py --data_path_accept_reject pgun_qqbar_finalTwo_accept_reject_z_a_0.72_b_0.88_sigma_0.335_N_1e4.txt 
...
--write_path_mT2_accept_reject pgun_qqbar_mT2_accept_reject_a_0.72_b_0.88_sigma_0.335_N_1e4.npy  
