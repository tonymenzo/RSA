...
# ad_points  = torch.linspace(0.67,0.75,20)
# # bd_points  = torch.linspace(0.7,1.1,10)
bd_points = torch.linspace(0.88, 0.98, 2)
# # bd_points  = torch.tensor([0.88])
# # sigma_points = torch.arange(0.328, 0.337, 0.001)
# sigma_points = torch.linspace(0.290, 0.336, 20)

ad_points  = torch.linspace(0.6,0.9,20)
# bd_points  = torch.linspace(0.7,1.1,10)
# bd_points  = torch.tensor([0.88])
# sigma_points = torch.arange(0.328, 0.337, 0.001)
