...
sim_obs          = ObservableDataset(sim_obs)
...
exp_obs          = ObservableDataset(exp_obs)
...
a1_points  = torch.linspace(0.7,1.0,20)
...
sigma_points = torch.linspace(0.220, 0.310, 20)
...
RSA = RSA_nD_tuner(epochs = epochs, dim_multiplicity = dim_multiplicity, dim_accept_reject = dim_accept_reject, over_sample_factor = over_sample_factor,
				...
				results_dir = "/pscratch/sd/l/ljpuslar/RSA/RSA/src/temp_results/Flowmap", params_init = params_learn, fixed_binning = True, loss_type='sliced_emd')
