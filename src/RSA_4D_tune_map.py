...
RSA = RSA_nD_tuner(epochs = epochs, dim_multiplicity = dim_multiplicity, dim_accept_reject = dim_accept_reject, over_sample_factor = over_sample_factor,
				...
				results_dir = "/pscratch/sd/l/ljpuslar/RSA/RSA/src/temp_results/Tuner_nD", params_init = params_learn, fixed_binning = True)
...
# Construct full path
folder_path = f'/pscratch/sd/l/ljpuslar/RSA/RSA/src/temp_results/Tune_map/{dim}D/'

# Create directory if it doesn't exist
os.makedirs(folder_path, exist_ok=True)

np.save(f'/pscratch/sd/l/ljpuslar/RSA/RSA/src/temp_results/Tune_map/{dim}D/all_params_{save_nm}', all_params)
np.save(f'/pscratch/sd/l/ljpuslar/RSA/RSA/src/temp_results/Tune_map/{dim}D/params_final_{save_nm}', params_final)
np.save(f'/pscratch/sd/l/ljpuslar/RSA/RSA/src/temp_results/Tune_map/{dim}D/loss_values_{save_nm}', loss_values)
