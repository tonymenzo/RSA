...
#         # param_array = [np.array([self.weight_nexus.params_a.clone().detach().numpy(), self.weight_nexus.params_b.clone().detach().numpy()])]
#         params_array = np.array([self.weight_nexus.params[k].clone().detach().numpy() for k,v in self.weight_nexus.params.items()])
#         batch_counter = 0
...
#                 # print(f'a: {self.weight_nexus.params_a.clone().detach().numpy()}, \n b: {self.weight_nexus.params_b.clone().detach().numpy()}')
#                 # for k,v in self.weight_nexus.params.items():
#                 #     print(k,v)
#                 # print(f'a: {self.weight_nexus.params_a.clone().detach().numpy()}, \n b: {self.weight_nexus.params_b.clone().detach().numpy()}')
#                 print('----------------------------------------------')

#                 # Record the tuned parameters
#                 np.append(params_array, np.array([self.weight_nexus.params[k].clone().detach().numpy() for k,v in self.weight_nexus.params.items()]))
