...
magnitudes = np.load('temp_results/Flow_map_nD/magnitudes_6.npy')
a_b_gradients = np.load('temp_results/Flow_map_nD/gradients_6.npy')
a_b_c = np.load('temp_results/Flow_map_nD/ad_bd_au_6.npy')
loss_grid = np.load('temp_results/Flow_map_nD/loss_grid_6.npy')
mu = np.load('temp_results/Flow_map_nD/mu_6.npy')
Neff = np.load('temp_results/Flow_map_nD/Neff_6.npy')
mu = mu[:,0]
